...
export default function Desktop({width, height, fill}: DesktopProps) {
    const pwidth = width ?? "32";
    const pheight = height ?? "32"
    const pfill = fill ?? "#000000"

    return <svg xmlns="http://www.w3.org/2000/svg" viewBox={`0 0 576 512`} fill={pfill} width={pwidth} height={pheight}>
